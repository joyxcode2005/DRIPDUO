    ...
    <div className="min-h-screen text-[#ECE7D1] overflow-x-clip w-full" ref={containerRef}>
      ...
      <section className="relative h-dvh w-full overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center w-full px-4 z-20 flex flex-col items-center">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1.2, ease: [0.16, 1, 0.3, 1], delay: 0.2 }} className="glass-panel px-12 py-10 md:px-20 md:py-14 rounded-[3rem] max-w-[90vw] md:max-w-max">
          ...
          <Reveal>
            <div className="font-serif text-[clamp(1.8rem,5vw,4.5rem)] leading-[1.3] text-white/60 max-w-6xl">
              ...
              <LinkPreview 
                ...
                className="font-bold text-[#ECE7D1] hover:text-[#EE3C24] transition-colors underline decoration-white/20 underline-offset-[8px]"
              >
                Story
              </LinkPreview>{" "}
              and explore the{" "}
