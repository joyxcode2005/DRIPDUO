...
export default function ProductCard({
    ...
    // Access global wishlist state and functions from the context
            ...
            <div className="relative aspect-4/5 w-full flex items-center justify-center bg-black/20 overflow-hidden">
                ...
                <div className="absolute top-4 left-4 right-4 flex justify-between z-10 text-red-700">
                    ...
                    <button
                        ...
                        className={`glass-button p-2.5 rounded-full transition-colors ml-auto shadow-md ${isWishlisted
                ...
                <button
                    disabled={isSoldOut}
                    onClick={onQuickAdd}
                    className={`absolute bottom-4 right-4 p-3 rounded-full transition-all shadow-md ${isAdded
