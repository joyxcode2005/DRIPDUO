...
const FooterSection = ({ title, links }: { title: string; links: string[] }) => {
  ...
  return (
    <div className="border-b border-white/10 md:border-none">
      ...
      <div className={`overflow-hidden transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] md:max-h-none md:opacity-100 ${open ? "max-h-[300px] opacity-100 mb-6" : "max-h-0 opacity-0"}`}>
...
export const Footer = () => {
  ...
  return (
    <footer className="relative bg-black/20 backdrop-blur-md pt-16 md:pt-24 border-t border-white/5 overflow-hidden flex flex-col z-10 w-full mt-20">
      ...
      {/* ── MAIN LINKS GRID ── */}
      <div className="w-full max-w-[2000px] mx-auto px-6 md:px-12 lg:px-16 xl:px-24 mb-16 md:mb-24 flex-1">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8">
          ...
          <div className="md:col-span-5 lg:col-span-4 flex flex-col justify-between">
            <div>
              ...
              <p className="font-sans text-[11px] md:text-[12px] leading-relaxed tracking-wider text-white/50 max-w-[300px]">
            ...
            <div className="flex gap-6 mt-10 md:mt-0">
              {[
                ...
                <a 
                  ...
                  className="font-sans text-[10px] uppercase tracking-[0.2em] text-white/70 hover:text-white glass-button px-4 py-2 rounded-full transition-all duration-300 shadow-md"
                >
                  {social.name}
                </a>
              ))}
