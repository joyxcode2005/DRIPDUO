      ...
      <div className="fixed top-0 left-0 right-0 z-[150] flex flex-col pointer-events-none">
        ...
        <AnimatePresence>
          {isBannerVisible && (
            ...
            >
              <div className="flex items-center justify-center py-2.5 px-4 md:px-10 min-h-[36px]">
          ...
          <div className="flex justify-between items-center px-4 md:px-10 lg:px-16 w-full">
            ...
            <div className="flex-1 flex justify-start z-50">
              <Link href="/" onClick={() => setMenuOpen(false)} className="relative group block">
                <div className="relative w-[110px] h-[35px] md:w-[170px] md:h-[50px]">
                  <Image
        ...
        {menuOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-1/2 right-4 md:right-[4vw] lg:right-[5vw] z-[120] w-[calc(100vw-2rem)] md:w-[48vw] lg:w-[38vw] md:max-w-[580px] bg-[#0D0D0B]/95 backdrop-blur-2xl border border-white/8 rounded-2xl md:rounded-xl overflow-hidden shadow-2xl"
            >
              {/* Top accent line */}
              <div className="h-px w-full bg-gradient-to-r from-transparent via-[#EE3C24] to-transparent opacity-60" />
